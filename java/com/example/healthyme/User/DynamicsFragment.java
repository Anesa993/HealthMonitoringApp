...
public class DynamicsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        while (cursorCI.moveToNext()) {
            totalCalories = Float.parseFloat(cursorCI.getString(1)); // Assuming calories are stored as floats
        }

        int progress = (int) totalCalories;
        caloriesProgress.setDonut_progress(String.valueOf(progress));
      //  caloriesProgress.setDonut_progress(String.valueOf(totalCalories));
        /*Cursor cursorCI = helper.getCI(finalId);
        String cal1 = "" ;
        while (cursorSL.moveToNext()) {
