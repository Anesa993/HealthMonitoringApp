package com.example.healthyme.Waterintake;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Get current time for the time picker
                Calendar calendar = Calendar.getInstance();
                int hour = calendar.get(Calendar.HOUR);  // 12-hour format
                int minute = calendar.get(Calendar.MINUTE);

                // Time Picker Dialog to pick the time
                TimePickerDialog timePickerDialog = new TimePickerDialog(NotificationReminder.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                String formattedTime = String.format("%02d:%02d %s", hourOfDay % 12 == 0 ? 12 : hourOfDay % 12, minute, am_pm);
                                Log.d("log", formattedTime);

                                // Create a new reminder and add to the list
                                ReminderHolder reminderHolder = new ReminderHolder(id, formattedTime);
