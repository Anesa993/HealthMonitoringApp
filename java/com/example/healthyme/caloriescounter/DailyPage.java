...
public class DailyPage extends AppCompatActivity {
    ...
    public static final String dietvalue = "valueKey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   actionBar.setDisplayHomeAsUpEnabled(true);
        ...
        editor.putString("dietvalue", String.valueOf(defaultCalories));
        editor.apply();
        Toast.makeText(DailyPage.this,"diet save",Toast.LENGTH_LONG).show();
