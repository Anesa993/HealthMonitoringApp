...
//            }
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                if (getActivity() != null && !isDetached()) {
                    ...
                    progressState = getActivity().getSharedPreferences("progress", Context.MODE_PRIVATE);
        ...
        SharedPreferences pref = getActivity().getSharedPreferences(waterintake.PrefTag, Context.MODE_PRIVATE);
        ...
        if (isDeleteCup) {
            ...
            editor.putBoolean(waterintake.PrefTag, false);
            editor.commit();
            progressState = getActivity().getApplicationContext().getSharedPreferences("progress", Context.MODE_PRIVATE);
            progress = String.valueOf(drinkProgressBar.getProgress());
            initViews();
...
//    }
    ...
    public void deleteCup(int ml) {
        ...
        SharedPreferences preferences = waterintake.context.getSharedPreferences(waterintake.PrefTag, Context.MODE_PRIVATE);
