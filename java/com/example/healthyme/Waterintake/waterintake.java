...
import com.example.healthyme.BuildConfig;
...
public class waterintake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WaterPagerAdapter pagerAdapter = new WaterPagerAdapter(getSupportFragmentManager(),
...
//    }
    ...
    /*public void checkFirstRun() {
        ...
        if (currentVersionCode == savedVersionCode) {
            ...
            Intent intent = new Intent(waterintake.this ,Pi.class );
    ...
    public void checkFirstRun() {
        SharedPreferences prefs = getSharedPreferences("PersonalInfoPrefs", MODE_PRIVATE);
        boolean isFirstTime = prefs.getBoolean("isFirstTime", true);

        if (isFirstTime) {
            // Launch the Personal Info screen
            Intent intent = new Intent(waterintake.this, Pi.class);
            startActivity(intent);
